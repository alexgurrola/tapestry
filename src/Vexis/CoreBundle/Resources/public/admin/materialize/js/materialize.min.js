...
function toast(t, e, i, n) {
    function o(t) {
        ...
        return e.hammer({prevent_default: !1}).bind("pan", function (t) {
            var i = t.gesture.deltaX, n = 80;
            e.hasClass("panning") || e.addClass("panning");
            var o = 1 - Math.abs(i / n);
            0 > o && (o = 0), e.velocity({left: i, opacity: o}, {duration: 50, queue: !1, easing: "easeOutQuad"})
        }).bind("panend", function (t) {
            var i = t.gesture.deltaX, o = 80;
            Math.abs(i) > o ? e.velocity({marginTop: "-40px"}, {
                duration: 375,
                easing: "easeOutExpo",
                queue: !1,
                complete: function () {
            ...
            }) : (e.removeClass("panning"), e.velocity({left: 0, opacity: 1}, {
                duration: 300,
                easing: "easeOutExpo",
                queue: !1
            }))
    ...
    if (i = i || "", 0 == $("#toast-container").length) {
        var a = $("<div></div>").attr("id", "toast-container");
        $("body").append(a)
    }
    var a = $("#toast-container"), r = o(t);
    a.append(r), r.css({top: parseFloat(r.css("top")) + 35 + "px", opacity: 0}), r.velocity({
        top: "0px",
        opacity: 1
    }, {duration: 300, easing: "easeOutCubic", queue: !1});
    var s = e, l = setInterval(function () {
        0 === r.parent().length && window.clearInterval(l), r.hasClass("panning") || (s -= 100), 0 >= s && (r.velocity({
            opacity: 0,
            marginTop: "-40px"
        }, {
...
jQuery.extend(jQuery.easing, {
    ...
    t(document).ready(function () {
        jQuery.fn.reverse = [].reverse, t(".fixed-action-btn").each(function () {
            var e = t(this);
            e.find("ul a.btn-floating").velocity({scaleY: ".4", scaleX: ".4", translateY: "40px"}, {duration: 0});
            e.hover(function () {
                var i = 0;
    ...
    t(document).ready(function () {
        t(".card > .card-reveal").each(function () {
            ...
            }) : (t(e.target).is(t(".card .activator")) || t(e.target).is(t(".card .activator i"))) && t(this).find(".card-reveal").velocity({translateY: "-100%"}, {
                duration: 300,
                queue: !1,
                easing: "easeInOutQuad"
            }))
    ...
    t.fn.collapsible = function (e) {
        ...
        return e = t.extend(i, e), this.each(function () {
            function i(t) {
                a = o.find(".collapsible-header"), t.parent().toggleClass("active"), t.parent().hasClass("active") ? t.siblings(".collapsible-body").stop(!0, !1).slideDown({
                    duration: 350,
                    easing: "easeOutQuart",
                    queue: !1
                    ...
                    easing: "easeOutQuart",
                    queue: !1
                }), a.not(t).parent().removeClass("active"), a.not(t).parent().children(".collapsible-body").stop(!0, !1).slideUp({
                    duration: 350,
                    easing: "easeOutQuart",
                    queue: !1
                })
            ...
            var o = t(this), a = t(this).find(".collapsible-header"), r = o.data("collapsible");
            o.off("click.collapse", ".collapsible-header"), a.off("click.collapse"), e.accordion || "accordion" == r || void 0 == r ? (o.on("click.collapse", ".collapsible-header", function (e) {
                i(t(e.currentTarget))
    ...
    t.fn.scrollTo = function (e) {
        ...
        e = t.extend(i, e), this.each(function () {
            function i() {
                void 0 != r.data("inDuration") && (e.inDuration = r.data("inDuration")), void 0 != r.data("outDuration") && (e.outDuration = r.data("outDuration")), void 0 != r.data("constrainwidth") && (e.constrain_width = r.data("constrainwidth")), void 0 != r.data("hover") && (e.hover = r.data("hover")), void 0 != r.data("alignment") && (e.alignment = r.data("alignment")), void 0 != r.data("gutter") && (e.gutter = r.data("gutter")), void 0 != r.data("beloworigin") && (e.belowOrigin = r.data("beloworigin"))
            }

            function n() {
                i(), 1 == e.constrain_width && s.css("width", r.outerWidth());
                var n = 0;
                1 == e.belowOrigin && (n = r.height());
                var a = 0, u = e.gutter;
                "right" == e.alignment && (a = r.innerWidth() - s.innerWidth(), u = -1 * u), s.css(o(r[0]) ? {
                    display: "block",
                    position: "fixed",
                    height: 0,
                    top: r.offset().top - t(window).scrollTop() + n,
                    left: r.offset().left + a + u
                } : {
                    display: "block",
                    top: r.offset().top + n,
                    left: r.offset().left + a + u,
            ...
            function o(e) {
                var i = t(e), n = i.add(i.parents()), o = !1;
                return n.each(function () {
                    return "fixed" === t(this).css("position") ? (o = !0, !1) : void 0
                }), o
            }

            function a() {
                s.velocity({opacity: 0}, {
                    duration: e.outDuration, easing: "easeOutQuad", complete: function () {
                        s.css({display: "none", "overflow-y": ""})
                    }
                })
            }

            var r = t(this), s = t("#" + r.attr("data-activates"));
            i(), s.parent().is(t("body")) || (s.detach(), t("body").append(s));
            var l = s.height();
            if (e.hover)r.on("mouseover", function () {
                n()
            }), s.on("mouseleave", function () {
                a()
            }); else {
                r.click(function (e) {
                    e.preventDefault(), e.stopPropagation(), n(), t(document).bind("click." + s.attr("id"), function (e) {
                        s.is(e.target) || r.is(e.target) || (a(), t(document).unbind("click." + s.attr("id")))
                    })
                }), r.parent(".btn-group")[0] && (r = r.parent(".btn-group"))
            }
            r.on("open", n), r.on("close", a), t(document).on("resize", function () {
            })
        })
    }
}(jQuery), function (t) {
    t(document).ready(function () {
        ...
        if (t(document).on("change", e, function () {
            ...
            var i = t('<div class="hiddendiv common"></div>'), n = null;
            t("body").append(i)
        }
        var o = ".materialize-textarea";
        t(".hiddendiv").css("width", t(o).width()), t(o).each(function () {
            ...
            t(this).find('input[type="file"]').change(function () {
                e.val(t(this).val()), e.trigger("change")
            })
        });
        ...
        t(document).on("mousedown", s, function (e) {
            ...
            t(this).each(function () {
                if ($select = t(this), !$select.hasClass("browser-default") && !$select.hasClass("initialized")) {
                    var i = l(), n = t('<div class="select-wrapper"></div>'), o = t('<ul id="select-options-' + i + '" class="dropdown-content select-dropdown"></ul>'), a = $select.children("option");
                    if (void 0 !== $select.find("option:selected"))var r = $select.find("option:selected"); else var r = o.first();
                    a.each(function () {
                    ...
                    var s = t('<input type="text" class="select-dropdown" readonly="true" ' + ($select.is(":disabled") ? "disabled" : "") + ' data-activates="select-options-' + i + '" value="' + r.html() + '"/><i class="mdi-navigation-arrow-drop-down">');
                    $select.before(s), t("body").append(o), $select.is(":disabled") || s.dropdown({hover: !1}), $select.addClass("initialized"), s.on("focus", function () {
                        ...
                        return 9 == e.which ? void s.trigger("close") : 40 != e.which || o.is(":visible") ? void((13 != e.which || o.is(":visible")) && (e.preventDefault(), letter = String.fromCharCode(e.which).toLowerCase(), letter && (filterQuery.push(letter), string = filterQuery.join(""), newOption = o.find("li").filter(function () {
    ...
    function T(t) {
        ...
        return new (e = i ? i : ye ? z : me ? N : ge ? R : L)(t, $)
    }

    function $(t, e, i) {
        var n = i.pointers.length, o = i.changedPointers.length, a = e & Ce && 0 === n - o, r = e & ($e | Oe) && 0 === n - o;
    ...
    function O(t, e) {
        ...
        var a = i.firstInput, r = i.firstMultiple, s = r ? r.center : a.center, l = e.center = A(n);
        e.timeStamp = pe(), e.deltaTime = e.timeStamp - a.timeStamp, e.angle = j(s, l), e.distance = q(s, l), P(i, e), e.offsetDirection = M(e.deltaX, e.deltaY), e.scale = r ? V(r.pointers, n) : 1, e.rotation = r ? _(r.pointers, n) : 0, E(i, e);
        var u = t.element;
    ...
    function P(t, e) {
        ...
        (e.eventType === Ce || a.eventType === $e) && (o = t.prevDelta = {
            x: a.deltaX || 0,
            y: a.deltaY || 0
    ...
    function E(t, e) {
        ...
        if (e.eventType != Oe && (l > Se || s.velocity === n)) {
            var u = s.deltaX - e.deltaX, c = s.deltaY - e.deltaY, d = I(l, u, c);
            o = d.x, a = d.y, i = he(d.x) > he(d.y) ? d.x : d.y, r = M(u, c), t.lastInterval = e
    ...
    function D(t) {
        ...
        return {timeStamp: pe(), pointers: e, center: A(e), deltaX: t.deltaX, deltaY: t.deltaY}
    }
    ...
    function M(t, e) {
        return t === e ? Pe : he(t) >= he(e) ? t > 0 ? Ee : De : e > 0 ? Ae : Ie
    }
    ...
    function _(t, e) {
        return j(e[1], e[0], Ve) - j(t[1], t[0], Ve)
    }

    function V(t, e) {
        return q(e[0], e[1], Ve) / q(t[0], t[1], Ve)
    }
    ...
    function Q(t, e) {
        ...
        return e & ($e | Oe) && (i = w(i.concat(n), "identifier", !0)), [i, n]
    }
    ...
    function W(t, e) {
        ...
        if (e & (Ce | Te) && 1 === i.length)return n[i[0].identifier] = !0, [i, i];
        var o, a, r = b(t.changedTouches), s = [], l = this.target;
        if (a = i.filter(function (t) {
                return v(t.target, l)
            }), e === Ce)for (o = 0; o < a.length;)n[a[o].identifier] = !0, o++;
        for (o = 0; o < r.length;)n[r[o].identifier] && s.push(r[o]), e & ($e | Oe) && delete n[r[o].identifier], o++;
    ...
    function R() {
        ...
        this.touch = new N(this.manager, t), this.mouse = new L(this.manager, t)
    }
    ...
    function X(t) {
        this.id = k(), this.manager = null, this.options = l(t || {}, this.defaults), this.options.enable = h(this.options.enable, !0), this.state = oi, this.simultaneous = {}, this.requireFail = []
    }
    ...
    function U(t) {
        return t == Ie ? "down" : t == Ae ? "up" : t == Ee ? "left" : t == De ? "right" : ""
    }
    ...
    function oe(t, e) {
        return e = e || {}, e.recognizers = h(e.recognizers, oe.defaults.preset), new ae(t, e)
    }

    function ae(t, e) {
        e = e || {}, this.options = l(e, oe.defaults), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.element = t, this.input = T(this), this.touchAction = new H(this, this.options.touchAction), re(this, !0), r(e.recognizers, function (t) {
    ...
    var Le = {mousedown: Ce, mousemove: Te, mouseup: $e}, ze = "mousedown", Fe = "mousemove mouseup";
    u(L, C, {
        handler: function (t) {
            var e = Le[t.type];
            e & Ce && 0 === t.button && (this.pressed = !0), e & Te && 1 !== t.which && (e = $e), this.pressed && this.allow && (e & $e && (this.pressed = !1), this.callback(this.manager, e, {
                pointers: [t],
                changedPointers: [t],
                pointerType: xe,
                srcEvent: t
    ...
    var Qe = {pointerdown: Ce, pointermove: Te, pointerup: $e, pointercancel: Oe, pointerout: Oe}, Ne = {
        2: be,
        3: we,
        4: xe,
        5: ke
    }, We = "pointerdown", Re = "pointermove pointerup pointercancel";
    t.MSPointerEvent && (We = "MSPointerDown", Re = "MSPointerMove MSPointerUp MSPointerCancel"), u(z, C, {
        handler: function (t) {
            var e = this.store, i = !1, n = t.type.toLowerCase().replace("ms", ""), o = Qe[n], a = Ne[t.pointerType] || t.pointerType, r = a == be, s = m(e, t.pointerId, "pointerId");
            o & Ce && (0 === t.button || r) ? 0 > s && (e.push(t), s = e.length - 1) : o & ($e | Oe) && (i = !0), 0 > s || (e[s] = t, this.callback(this.manager, o, {
                pointers: e,
                changedPointers: [t],
                pointerType: a,
                srcEvent: t
    ...
    u(F, C, {
        handler: function (t) {
            ...
            if (e === Ce && (this.started = !0), this.started) {
                ...
                e & ($e | Oe) && 0 === i[0].length - i[1].length && (this.started = !1), this.callback(this.manager, e, {
                    pointers: i[0],
                    changedPointers: i[1],
                    pointerType: be,
                    srcEvent: t
    ...
    u(N, C, {
        ...
        handler: function (t, e, i) {
            ...
            e & ($e | Oe) && (this.mouse.allow = !0), this.callback(t, e, i)
        }, destroy: function () {
    ...
    H.prototype = {
        set: function (t) {
            ...
            if (!Ze) {
                ...
                return o || a && i & Me || r && i & qe ? this.preventSrc(e) : void 0
            }
    ...
    X.prototype = {
        ...
        defaults: {pointers: 1}, attrTest: function (t) {
            ...
            return n && (i & Oe || !o) ? e | ui : n || o ? i & $e ? e | si : e & ai ? e | ri : ai : ci
        }
    }), u(J, Z, {
        defaults: {event: "pan", threshold: 10, pointers: 1, direction: je}, getTouchAction: function () {
            var t = this.options.direction, e = [];
            return t & Me && e.push(ni), t & qe && e.push(ii), e
        }, directionTest: function (t) {
            var e = this.options, i = !0, n = t.distance, o = t.direction, a = t.deltaX, r = t.deltaY;
            return o & e.direction || (e.direction & Me ? (o = 0 === a ? Pe : 0 > a ? Ee : De, i = a != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === r ? Pe : 0 > r ? Ae : Ie, i = r != this.pY, n = Math.abs(t.deltaY))), t.direction = o, i && n > e.threshold && o & e.direction
        }, attrTest: function (t) {
        ...
        defaults: {event: "press", pointers: 1, time: 500, threshold: 5}, getTouchAction: function () {
            ...
            if (this._input = t, !n || !i || t.eventType & ($e | Oe) && !a)this.reset(); else if (t.eventType & Ce)this.reset(), this._timer = o(function () {
                this.state = li, this.tryEmit()
            }, e.time, this); else if (t.eventType & $e)return li;
            return ci
        }, reset: function () {
            clearTimeout(this._timer)
        }, emit: function (t) {
            this.state === li && (t && t.eventType & $e ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = pe(), this.manager.emit(this.options.event, this._input)))
        }
    }), u(ee, Z, {
        ...
        defaults: {event: "swipe", threshold: 10, velocity: .65, direction: Me | qe, pointers: 1},
        getTouchAction: function () {
            return J.prototype.getTouchAction.call(this)
        },
        attrTest: function (t) {
            var e, i = this.options.direction;
            return i & (Me | qe) ? e = t.velocity : i & Me ? e = t.velocityX : i & qe && (e = t.velocityY), this._super.attrTest.call(this, t) && i & t.direction && t.distance > this.options.threshold && he(e) > this.options.velocity && t.eventType & $e
        },
        emit: function (t) {
            var e = U(t.direction);
        ...
        inputTarget: null,
        inputClass: null,
        preset: [[ee, {enable: !1}], [K, {enable: !1}, ["rotate"]], [ie, {direction: Me}], [J, {direction: Me}, ["swipe"]], [ne], [ne, {
            event: "doubletap",
            taps: 2
        }, ["tap"]], [te]],
        cssProps: {
    ...
    ae.prototype = {
        set: function (t) {
            ...
            if (!e.stopped) {
                ...
                for (var a = 0; a < n.length;)i = n[a], e.stopped === hi || o && i != o && !i.canRecognizeWith(o) ? i.reset() : i.recognize(t), !o && i.state & (ai | ri | si) && (o = e.curRecognizer = i), a++
            }
        }, get: function (t) {
    ...
    t.fn.extend({
        ...
        closeModal: function (e) {
            var i = {out_duration: 200, complete: void 0}, e = t.extend(i, e);
            t("#lean-overlay").velocity({opacity: 0}, {
    ...
    t.fn.materialbox = function () {
        return this.each(function () {
            function e() {
                ...
                t("#materialbox-overlay").fadeOut(a, function () {
                    i = !1, t(this).remove()
            ...
            if (!t(this).hasClass("intialized")) {
                ...
                r.wrap(s), r.on("click", function () {
                    ...
                    if (t("body").append(d), d.velocity({opacity: 1}, {
                        ...
                        h.text(r.data("caption")), t("body").append(h), h.css({display: "inline"}), h.velocity({opacity: 1}, {
                            duration: o,
                            queue: !1,
                            easing: "easeOutQuad"
                        })
                    }
                    var p = 0, f = u / s, v = c / l, g = 0, y = 0;
                    f > v ? (p = c / u, g = .9 * s, y = .9 * s * p) : (p = u / c, g = .9 * l * p, y = .9 * l), r.hasClass("responsive-img") ? r.velocity({
                        "max-width": g,
                        width: u
                    }, {
    ...
    t.fn.parallax = function () {
        ...
        return this.each(function () {
            function i(i) {
                var o;
                o = 992 > e ? n.height() > 0 ? n.height() : n.children("img").height() : n.height() > 0 ? n.height() : 500;
                var a = n.children("img").height(), r = a - o, s = n.offset().top + o, l = n.offset().top, u = t(window).scrollTop(), c = window.innerHeight, d = u + c, h = (d - l) / (o + c), p = -1 * r * h;
                s > u && u + c > l && n.children("img").first().css("bottom", p + "px"), i && n.children("img").first().css("display", "block")
            }

            var n = t(this);
            n.addClass("parallax"), n.children("img").load(function () {
                i(!0)
            }), t(window).scroll(function () {
    ...
    t(document).ready(function () {
        ...
        t.fn.pushpin = function (i) {
            ...
            return i = t.extend(n, i), $index = 0, this.each(function () {
                ...
                function o(e, o) {
                    e.each(function () {
                        i.top <= o && i.bottom >= o && !t(this).hasClass("pinned") && (n(t(this)), t(this).css("top", i.offset), t(this).addClass("pinned")), o < i.top && !t(this).hasClass("pin-top") && (n(t(this)), t(this).css("top", 0), t(this).addClass("pin-top")), o > i.bottom && !t(this).hasClass("pin-bottom") && (n(t(this)), t(this).addClass("pin-bottom"), t(this).css("top", i.bottom - s))
                    })
                }

                var a = e(), r = t(this), s = t(this).offset().top;
                o(r, t(window).scrollTop()), t(window).on("scroll." + a, function () {
    ...
    scrollFire = function (e) {
        t(window).scroll(function () {
            ...
            t.each(e, function (e, n) {
                var o = n.selector, a = n.offset, r = n.callback, s = t(o).offset().top;
                if (i > s + a && void 0 === t(o).data("done")) {
                    var l = new Function(r);
                    l(), t(o).data("done", !0)
                }
            })
        })
    ...
    t.scrollSpy = function (e, n) {
        ...
        e = t(e), e.each(function (e, i) {
            r.push(t(i)), t(i).data("scrollSpy:id", e), t("a[href=#" + t(i).attr("id") + "]").click(function (e) {
                ...
                t(".tabs-wrapper").length ? t("html, body").animate({scrollTop: i - 60}, {
                    duration: 400,
                    easing: "easeOutCubic"
                }) : t("html, body").animate({scrollTop: i}, {duration: 400, easing: "easeOutCubic"})
            })
    ...
    var e = {
        init: function (e) {
            ...
            e = t.extend(i, e), t(this).each(function () {
                ...
                240 != e.menuWidth && (o.css("width", e.menuWidth), o.hasClass("fixed") || o.css("left", -1 * (e.menuWidth + 10))), "left" != e.edge && o.addClass("right-aligned"), t("body").append(t('<div class="drag-target"></div>')), t(".drag-target").css("left" === e.edge ? {left: 0} : {right: 0}), o.hasClass("fixed") && t(window).resize(function () {
                    t(window).width() > 1200 && o.attr("style") && (o.removeAttr("style"), o.css("width", e.menuWidth)), 0 != t("#sidenav-overlay").css("opacity") && r && t("#sidenav-overlay").trigger("click")
                }), 1 == e.closeOnClick && o.on("click.itemclick", "a:not(.collapsible-header)", function () {
                    i()
                });
                var a = !1, r = !1;
                t(".drag-target").hammer({prevent_default: !1}).bind("tap", function () {
                    ...
                    if ("touch" === n.gesture.pointerType) {
                        ...
                        if ("left" === e.edge ? a > e.menuWidth ? a = e.menuWidth : 0 > a && (a = 0) : a < t(window).width() - e.menuWidth && (a = t(window).width() - e.menuWidth), "left" === e.edge ? a < e.menuWidth / 2 ? r = !1 : a >= e.menuWidth / 2 && (r = !0) : a < t(window).width() - e.menuWidth / 2 ? r = !0 : a >= t(window).width() - e.menuWidth / 2 && (r = !1), "left" === e.edge ? o.css("left", a - e.menuWidth) : o.css("right", -1 * (a - e.menuWidth / 2)), "left" === e.edge) {
                            var l = a / e.menuWidth;
                            t("#sidenav-overlay").velocity({opacity: l}, {
                                duration: 50,
                                queue: !1,
                                easing: "easeOutQuad"
                            })
                        } else {
                            var l = Math.abs((a - t(window).width()) / e.menuWidth);
                            t("#sidenav-overlay").velocity({opacity: l}, {
                                duration: 50,
                                queue: !1,
                                easing: "easeOutQuad"
                    ...
                    if ("touch" === i.gesture.pointerType) {
                        ...
                        a = !1, "left" === e.edge ? r || -.5 > n ? (o.velocity({left: 0}, {
                            duration: 300,
                            queue: !1,
                            easing: "easeOutQuad"
                        ...
                        }), t(".drag-target").css({width: "10%", right: 0, left: ""}))
                    }
                }), n.click(function () {
                    if (o.hasClass("active"))r = !1, a = !1, i(); else {
                        "left" === e.edge ? (t(".drag-target").css({
                            width: "50%",
                            right: 0,
                            left: ""
                            ...
                            right: "",
                            left: 0
                        }), o.velocity({right: 0}, {duration: 300, queue: !1, easing: "easeOutQuad"}));
                        var n = t('<div id="sidenav-overlay"></div>');
                        n.css("opacity", 0).click(function () {
                            r = !1, a = !1, i(), n.animate({opacity: 0}, {
                                duration: 300,
                                queue: !1,
                                easing: "easeOutQuad",
                                complete: function () {
                        ...
                        }), t("body").append(n), n.animate({opacity: 1}, {
                            duration: 300,
                            queue: !1,
                            easing: "easeOutQuad",
                            complete: function () {
    ...
    t.fn.slider = function (e) {
        ...
        return e = t.extend(i, e), this.each(function () {
            ...
            function n(t) {
                console.log("Move to slide"), t >= s.length ? t = 0 : 0 > t && (t = s.length - 1), l = r.find(".active").index(), l != t && (o = s.eq(l), $caption = o.find(".caption"), o.removeClass("active"), o.velocity({opacity: 0}, {
            ...
            if (-1 != l && (o = s.eq(l)), 400 != e.height && (a.height(e.height + 40), r.height(e.height)), s.find(".caption").each(function () {
                    ...
                    t(this).css("background-image", "url(" + t(this).attr("src") + ")"), t(this).attr("src", "")
                }), e.indicators) {
            ...
            a.hammer({prevent_default: !1}).bind("pan", function (t) {
                if ("touch" === t.gesture.pointerType) {
                    ...
                    $curr_slide = r.find(".active"), $curr_slide.velocity({translateX: i}, {
                        ...
                        queue: !1,
                        easing: "easeOutQuad"
                    }), 4 === e && (i > a.innerWidth() / 2 || -.65 > n) ? h = !0 : 2 === e && (i < -1 * a.innerWidth() / 2 || n > .65) && (d = !0);
                    var o;
                    d && (o = $curr_slide.next(), 0 === o.length && (o = s.first()), o.velocity({opacity: 1}, {
                        duration: 300,
                        queue: !1,
                        easing: "easeOutQuad"
                    })), h && (o = $curr_slide.prev(), 0 === o.length && (o = s.last()), o.velocity({opacity: 1}, {
                        duration: 300,
                        queue: !1,
                        easing: "easeOutQuad"
                    }))
                ...
                "touch" === t.gesture.pointerType && ($curr_slide = r.find(".active"), c = !1, curr_index = r.find(".active").index(), h || d ? d ? (n(curr_index + 1), $curr_slide.velocity({translateX: -1 * a.innerWidth()}, {
                    duration: 300,
                    queue: !1,
                    easing: "easeOutQuad",
                    complete: function () {
                ...
                })) : h && (n(curr_index - 1), $curr_slide.velocity({translateX: a.innerWidth()}, {
                    duration: 300,
                    queue: !1,
                    easing: "easeOutQuad",
                    complete: function () {
    ...
    var e = {
        init: function () {
            return this.each(function () {
                function e() {
                    return c = h.hasClass("rtl"), c ? {right: u * l, left: s - (u + 1) * l} : {
                        right: s - (u + 1) * l,
                        left: u * l
                    }
                }
                ...
                var d = i.find(".indicator"), h = t("html");
                if (i.is(":visible")) {
                    var p = e();
                    d.css({right: p.right}), d.css({left: p.left})
                }
                t(window).resize(function () {
                    if (s = i.width(), l = i.find("li").first().outerWidth(), 0 > u && (u = 0), 0 !== l && 0 !== s) {
                        var t = e();
                        d.css({right: t.right}), d.css({left: t.left})
                    }
                    ...
                    var p = e();
                    !c && u - h >= 0 || c && 0 > u - h ? (d.velocity({right: p.right}, {
                        duration: 300,
                        queue: !1,
                        easing: "easeOutQuad"
                    }), d.velocity({left: p.left}, {
                        duration: 300,
                        queue: !1,
                        easing: "easeOutQuad",
                        delay: 90
                ...
                mouseenter: function (t) {
                    ...
                    s = void 0 == s || "" == s ? e.delay : s, i = 0, o = setInterval(function () {
                        if (i += 10, i >= s && 0 == n) {
                            ...
                            var t = r.outerWidth(), e = r.outerHeight(), o = r.attr("data-position"), c = l.outerHeight(), d = l.outerWidth(), h = "0px", p = "0px", f = 8;
                            "top" === o ? (l.css({
                                ...
                                left: r.offset().left + t / 2 - d / 2
                            }), h = "+10px", u.css({marginLeft: d / 2 - u.width() / 2})), f = d / 8, 8 > f && (f = 8), ("right" === o || "left" === o) && (f = d / 10, 6 > f && (f = 6)), l.velocity({
                                opacity: 1,
                                marginTop: h,
                                marginLeft: p
    ...
    t(document).ready(function () {
        var e = 0;
        showStaggeredList = function (i) {
            t(i).find("li").velocity({translateX: "-100px"}, {duration: 0}), t(i).find("li").each(function () {
                t(this).velocity({opacity: "1", translateX: "0"}, {duration: 800, delay: e, easing: [60, 10]}), e += 120
            })
        };
        var i = [];
        t("ul.staggered-list").each(function (e) {
            var n = "scrollFire-" + e;
            t(this).addClass(n), i.push({
                selector: "ul.staggered-list." + n,
                offset: 200,
                callback: 'showStaggeredList("ul.staggered-list.' + n + '")'
            })
        }), scrollFire(i), fadeInImage = function (e) {
            var i = t(e);
            i.css({opacity: 0}), t(i).velocity({opacity: 1}, {
                duration: 650,
                queue: !1,
                easing: "easeOutSine"
            }), t(i).animate({opacity: 1}, {
    ...
    return function (t, e, i, n) {
        ...
        function l(t, i, n, o) {
            ...
            function p(e) {
                ...
                return l >= g ? c(e, s) : 0 == l ? s : h(e, i, i + w)
            }
            ...
            var S = x ? new Float32Array(b) : new Array(b), C = !1, T = function (e) {
                return C || f(), t === i && n === o ? e : 0 === e ? 0 : 1 === e ? 1 : l(p(e), i, o)
            };
            T.getControlPoints = function () {
                return [{x: t, y: i}, {x: n, y: o}]
            };
            var $ = "generateBezier(" + [t, i, n, o] + ")";
        ...
        function c(t) {
            if (t)for (var e = (new Date).getTime(), i = 0, o = b.State.calls.length; o > i; i++)if (b.State.calls[i]) {
                var a = b.State.calls[i], s = a[0], l = a[2], u = a[3], p = !!u;
                u || (u = b.State.calls[i][3] = e - 16);
                for (var f = Math.min((e - u) / l.duration, 1), g = 0, y = s.length; y > g; g++) {
                    var m = s[g], w = m.element;
                    if (r(w)) {
                        var k = !1;
                        ...
                        for (var T in m)if ("element" !== T) {
                            var $, O = m[T], P = v.isString(O.easing) ? b.Easings[O.easing] : O.easing;
                            if (1 === f)$ = O.endValue; else if ($ = O.startValue + (O.endValue - O.startValue) * P(f), !p && $ === O.currentValue)continue;
                            if (O.currentValue = $, x.Hooks.registered[T]) {
                                var E = x.Hooks.getRoot(T), D = r(w).rootPropertyValueCache[E];
                                D && (O.rootPropertyValue = D)
                            }
                            var A = x.setPropertyValue(w, T, O.currentValue + (0 === parseFloat($) ? "" : O.unitType), O.rootPropertyValue, O.scrollData);
                            x.Hooks.registered[T] && (r(w).rootPropertyValueCache[E] = x.Normalizations.registered[E] ? x.Normalizations.registered[E]("extract", null, A[1]) : A[1]), "transform" === A[0] && (k = !0)
                        }
                        l.mobileHA && r(w).transformCache.translate3d === n && (r(w).transformCache.translate3d = "(0px, 0px, 0px)", k = !0), k && x.flushTransformCache(w)
                    }
                }
                l.display !== n && "none" !== l.display && (b.State.calls[i][2].display = !1), l.visibility !== n && "hidden" !== l.visibility && (b.State.calls[i][2].visibility = !1), l.progress && l.progress.call(a[1], a[1], f, Math.max(0, u + l.duration - e), u), 1 === f && d(i)
            }
        ...
        function d(t, e) {
            ...
            for (var i = b.State.calls[t][0], o = b.State.calls[t][1], a = b.State.calls[t][2], s = b.State.calls[t][4], l = !1, u = 0, c = i.length; c > u; u++) {
                var d = i[u].element;
                if (e || a.loop || ("none" === a.display && x.setPropertyValue(d, "display", a.display), "hidden" === a.visibility && x.setPropertyValue(d, "visibility", a.visibility)), a.loop !== !0 && (h.queue(d)[1] === n || !/\.velocityQueueEntryFlag/i.test(h.queue(d)[1])) && r(d)) {
                    ...
                    }), a.mobileHA && (p = !0, delete r(d).transformCache.translate3d), p && x.flushTransformCache(d), x.Values.removeClass(d, "velocity-animating")
                }
                ...
                s && a.loop !== !0 && s(o), a.loop !== !0 || e || (h.each(r(d).tweensContainer, function (t, e) {
        ...
        var w = function () {
            ...
            return function n(t, e, o) {
                var a, r, s, l = {x: -1, v: 0, tension: null, friction: null}, u = [0], c = 0, d = 1e-4, h = .016;
                for (t = parseFloat(t) || 500, e = parseFloat(e) || 20, o = o || null, l.tension = t, l.friction = e, a = null !== o, a ? (c = n(t, e), r = c / o * h) : r = h; s = i(s || l, r), u.push(1 + s.x), c += 16, Math.abs(s.x) > d && Math.abs(s.v) > d;);
                return a ? function (t) {
        ...
        var x = b.CSS = {
            ...
            Hooks: {
                templates: {
                    ...
                    var i, n, o;
                    if (p)for (i in x.Hooks.templates) {
            ...
            getPropertyValue: function (t, i, o, a) {
                function s(t, i) {
                    ...
                    if (8 >= p)l = h.css(t, i); else {
                        ...
                        var f;
                        f = r(t) === n ? e.getComputedStyle(t, null) : r(t).computedStyle ? r(t).computedStyle : r(t).computedStyle = e.getComputedStyle(t, null), (p || b.State.isFirefox) && "borderColor" === i && (i = "borderTopColor"), l = 9 === p && "filter" === i ? f.getPropertyValue(i) : f[i], ("" === l || null === l) && (l = t.style[i]), o()
                    }
                ...
                return /^[\d-]/.test(l) || (l = r(t) && r(t).isSVG && x.Names.SVGAttribute(i) ? /^(height|width)$/i.test(i) ? t.getBBox()[i] : t.getAttribute(i) : s(t, x.Names.prefixCheck(i)[0])), x.Values.isCSSNullValue(l) && (l = 0), b.debug >= 2 && console.log("Get " + i + ": " + l), l
            },
            ...
            flushTransformCache: function (t) {
                ...
                if ((p || b.State.isAndroid && !b.State.isChrome) && r(t).isSVG) {
                    ...
                    h.each(r(t).transformCache, function (e) {
                        return o = r(t).transformCache[e], "transformPerspective" === e ? (a = o, !0) : (9 === p && "rotateZ" === e && (e = "rotate"), void(i += e + o + " "))
                    }), a && (i = "perspective" + a + " " + i)
                }
        ...
        var k = function () {
            ...
            function s() {
                function t() {
                    function t(t, e) {
                        var i = n, o = n, a = n;
                        return v.isArray(t) ? (i = t[0], !v.isArray(t[1]) && /^[\d-]/.test(t[1]) || v.isFunction(t[1]) || x.RegEx.isHex.test(t[1]) ? a = t[1] : (v.isString(t[1]) && !x.RegEx.isHex.test(t[1]) || v.isArray(t[1])) && (o = e ? t[1] : u(t[1], l.duration), t[2] !== n && (a = t[2]))) : i = t, e || (o = o || l.easing), v.isFunction(i) && (i = i.call(s, T, C)), v.isFunction(a) && (a = a.call(s, T, C)), [i || 0, o, a]
                    }
                    ...
                    function f() {
                        ...
                        }, n = t.position === j.lastPosition && t.myParent === j.lastParent, o = t.fontSize === j.lastFontSize;
                        j.lastParent = t.myParent, j.lastPosition = t.position, j.lastFontSize = t.fontSize;
                        var a = 100, l = {};
                        if (o && n)l.emToPx = j.lastEmToPx, l.percentToPxWidth = j.lastPercentToPxWidth, l.percentToPxHeight = j.lastPercentToPxHeight; else {
                            var u = r(s).isSVG ? i.createElementNS("http://www.w3.org/2000/svg", "rect") : i.createElement("div");
                            ...
                            }), b.CSS.setPropertyValue(u, "paddingLeft", a + "em"), l.percentToPxWidth = j.lastPercentToPxWidth = (parseFloat(x.getPropertyValue(u, "width", null, !0)) || 1) / a, l.percentToPxHeight = j.lastPercentToPxHeight = (parseFloat(x.getPropertyValue(u, "height", null, !0)) || 1) / a, l.emToPx = j.lastEmToPx = (parseFloat(x.getPropertyValue(u, "paddingLeft")) || 1) / a, t.myParent.removeChild(u)
                        }
                    ...
                    if ("scroll" === E) {
                        var k, S, $, O = /^x$/i.test(l.axis) ? "Left" : "Top", D = parseFloat(l.offset) || 0;
                        l.container ? v.isWrapped(l.container) || v.isNode(l.container) ? (l.container = l.container[0] || l.container, k = l.container["scroll" + O], $ = k + h(s).position()[O.toLowerCase()] + D) : l.container = null : (k = b.State.scrollAnchor[b.State["scrollProperty" + O]], S = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === O ? "Top" : "Left")]], $ = h(s).offset()[O.toLowerCase()] + D), d = {
                            scroll: {
                                rootPropertyValue: !1,
                                startValue: k,
                                currentValue: k,
                                ...
                                unitType: "",
                                easing: l.easing,
                                scrollData: {container: l.container, direction: O, alternateValue: S}
                            }, element: s
                        }, b.debug && console.log("tweensContainer (scroll): ", d.scroll, s)
                    } else if ("reverse" === E) {
                        if (!r(s).tweensContainer)return void h.dequeue(s, l.queue);
                        "none" === r(s).opts.display && (r(s).opts.display = "auto"), "hidden" === r(s).opts.visibility && (r(s).opts.visibility = "visible"), r(s).opts.loop = !1, r(s).opts.begin = null, r(s).opts.complete = null, w.easing || delete l.easing, w.duration || delete l.duration, l = h.extend({}, r(s).opts, l);
                        var A = h.extend(!0, {}, r(s).tweensContainer);
                        for (var I in A)if ("element" !== I) {
                            var M = A[I].startValue;
                            A[I].startValue = A[I].currentValue = A[I].endValue, A[I].endValue = M, v.isEmptyObject(w) || (A[I].easing = l.easing), b.debug && console.log("reverse tweensContainer (" + I + "): " + JSON.stringify(A[I]), s)
                        }
                        d = A
                    } else if ("start" === E) {
                        var A;
                        r(s).tweensContainer && r(s).isAnimating === !0 && (A = r(s).tweensContainer), h.each(m, function (e, i) {
                            if (RegExp("^" + x.Lists.colors.join("$|^") + "$").test(e)) {
                                ...
                                if (x.RegEx.isHex.test(a)) {
                                    for (var l = ["Red", "Green", "Blue"], u = x.Values.hexToRgb(a), c = s ? x.Values.hexToRgb(s) : n, d = 0; d < l.length; d++) {
                                        var h = [u[d]];
                                        r && h.push(r), c !== n && h.push(c[d]), m[e + l[d]] = h
                                    }
                                    delete m[e]
                                }
                            }
                        ...
                        for (var q in m) {
                            var V = t(m[q]), L = V[0], z = V[1], F = V[2];
                            q = x.Names.camelCase(q);
                            var Q = x.Hooks.getRoot(q), N = !1;
                            if (r(s).isSVG || x.Names.prefixCheck(Q)[1] !== !1 || x.Normalizations.registered[Q] !== n) {
                                (l.display !== n && null !== l.display && "none" !== l.display || l.visibility !== n && "hidden" !== l.visibility) && /opacity|filter/.test(q) && !F && 0 !== L && (F = 0), l._cacheValues && A && A[q] ? (F === n && (F = A[q].endValue + A[q].unitType), N = r(s).rootPropertyValueCache[Q]) : x.Hooks.registered[q] ? F === n ? (N = x.getPropertyValue(s, Q), F = x.getPropertyValue(s, q, N)) : N = x.Hooks.templates[Q][1] : F === n && (F = x.getPropertyValue(s, q));
                                var W, R, H, Y = !1;
                                if (W = p(q, F), F = W[0], H = W[1], W = p(q, L), L = W[0].replace(/^([+-\/*])=/, function (t, e) {
                                        return Y = e, ""
                                    }), R = W[1], F = parseFloat(F) || 0, L = parseFloat(L) || 0, "%" === R && (/^(fontSize|lineHeight)$/.test(q) ? (L /= 100, R = "em") : /^scale/.test(q) ? (L /= 100, R = "") : /(Red|Green|Blue)$/i.test(q) && (L = L / 100 * 255, R = "")), /[\/*]/.test(Y))R = H; else if (H !== R && 0 !== F)if (0 === L)R = H; else {
                                    a = a || f();
                                    var X = /margin|padding|left|right|width|text|word|letter/i.test(q) || /X$/.test(q) || "x" === q ? "x" : "y";
                                    switch (H) {
                                        case"%":
                                            F *= "x" === X ? a.percentToPxWidth : a.percentToPxHeight;
                                            break;
                                        case"px":
                                            break;
                                        default:
                                    ...
                                    switch (R) {
                                        case"%":
                                            F *= 1 / ("x" === X ? a.percentToPxWidth : a.percentToPxHeight);
                                            break;
                                        case"px":
                                            break;
                                        default:
                                ...
                                d[q] = {
                                    ...
                                    unitType: R,
                                    easing: z
                                }, b.debug && console.log("tweensContainer (" + q + "): " + JSON.stringify(d[q]), s)
                            } else b.debug && console.log("Skipping [" + Q + "] due to a lack of browser support.")
                        }
                        d.element = s
                    }
                    d.element && (x.Values.addClass(s, "velocity-animating"), _.push(d), "" === l.queue && (r(s).tweensContainer = d, r(s).opts = l), r(s).isAnimating = !0, T === C - 1 ? (b.State.calls.length > 1e4 && (b.State.calls = o(b.State.calls)), b.State.calls.push([_, g, l, null, P.resolver]), b.State.isTicking === !1 && (b.State.isTicking = !0, c())) : T++)
                }

                var a, s = this, l = h.extend({}, b.defaults, w), d = {};
                switch (r(s) === n && b.init(s), parseFloat(l.delay) && l.queue !== !1 && h.queue(s, l.queue, function (t) {
                    b.velocityQueueEntryFlag = !0, r(s).delayTimer = {
                ...
                b.mock !== !1 && (b.mock === !0 ? l.duration = l.delay = 1 : (l.duration *= parseFloat(b.mock) || 1, l.delay *= parseFloat(b.mock) || 1)), l.easing = u(l.easing, l.duration), l.begin && !v.isFunction(l.begin) && (l.begin = null), l.progress && !v.isFunction(l.progress) && (l.progress = null), l.complete && !v.isFunction(l.complete) && (l.complete = null), l.display !== n && null !== l.display && (l.display = l.display.toString().toLowerCase(), "auto" === l.display && (l.display = b.CSS.Values.getDisplayType(s))), l.visibility !== n && null !== l.visibility && (l.visibility = l.visibility.toString().toLowerCase()), l.mobileHA = l.mobileHA && b.State.isMobile && !b.State.isGingerbread, l.queue === !1 ? l.delay ? setTimeout(t, l.delay) : t() : h.queue(s, l.queue, function (e, i) {
                    return i === !0 ? (P.promise && P.resolver(g), !0) : (b.velocityQueueEntryFlag = !0, void t(e))
                }), "" !== l.queue && "fx" !== l.queue || "inprogress" === h.queue(s)[0] || h.dequeue(s)
            }

            var l, p, f, g, m, w, S = arguments[0] && (h.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || v.isString(arguments[0].properties));
            if (v.isWrapped(this) ? (l = !1, f = 0, g = this, p = this) : (l = !0, f = 1, g = S ? arguments[0].elements : arguments[0]), g = a(g)) {
                S ? (m = arguments[0].properties, w = arguments[0].options) : (m = arguments[f], w = arguments[f + 1]);
                var C = g.length, T = 0;
                if ("stop" !== m && !h.isPlainObject(w)) {
                    var $ = f + 1;
                    w = {};
                ...
                switch (m) {
                    ...
                    case"stop":
                        ...
                        return h.each(b.State.calls, function (t, e) {
                            e && h.each(e[1], function (i, o) {
                                var a = v.isString(w) ? w : "";
                                return w !== n && e[2].queue !== a ? !0 : void h.each(g, function (e, i) {
                                    i === o && (w !== n && (h.each(h.queue(i, a), function (t, e) {
                                        v.isFunction(e) && e(null, !0)
                                    }), h.queue(i, a, [])), r(i) && "" === a && h.each(r(i).tweensContainer, function (t, e) {
                    ...
                    default:
                        if (!h.isPlainObject(m) || v.isEmptyObject(m)) {
                            if (v.isString(m) && b.Redirects[m]) {
                                var A = h.extend({}, w), I = A.duration, M = A.delay || 0;
                                return A.backwards === !0 && (g = h.extend(!0, [], g).reverse()), h.each(g, function (t, e) {
                                    parseFloat(A.stagger) ? A.delay = M + parseFloat(A.stagger) * t : v.isFunction(A.stagger) && (A.delay = M + A.stagger.call(e, t, C)), A.drag && (A.duration = parseFloat(I) || (/^(callout|transition)/.test(m) ? 1e3 : y), A.duration = Math.max(A.duration * (A.backwards ? 1 - t / C : (t + 1) / C), .75 * A.duration, 200)), b.Redirects[m].call(e, e, A || {}, t, C, g, P.promise ? P : n)
                                }), t()
                            }
                            var q = "Velocity: First argument (" + m + ") was not a property map, a known action, or a registered redirect. Aborting.";
                            return P.promise ? P.rejecter(new Error(q)) : console.log(q), t()
                        }
                        E = "start"
                }
                var j = {
                ...
                var V, A = h.extend({}, b.defaults, w);
                if (A.loop = parseInt(A.loop), V = 2 * A.loop - 1, A.loop)for (var L = 0; V > L; L++) {
                    var z = {delay: A.delay, progress: A.progress};
                    L === V - 1 && (z.display = A.display, z.visibility = A.visibility, z.complete = A.complete), k(g, "reverse", z)
                }
                return t()
            }
        };
        ...
        return b.State.isMobile || i.hidden === n || i.addEventListener("visibilitychange", function () {
            ...
            b.Redirects["slide" + e] = function (t, i, o, a, r, s) {
                var l = h.extend({}, i), u = l.begin, c = l.complete, d = {
                    height: "",
                    marginTop: "",
                    marginBottom: "",
                    paddingTop: "",
            ...
            b.Redirects["fade" + e] = function (t, i, o, a, r, s) {
                var l = h.extend({}, i), u = {opacity: "In" === e ? 1 : 0}, c = l.complete;
    ...
    function a(t) {
        ...
        for (var e = null, i = t.target || t.srcElement; null !== i.parentElement;) {
            if ("string" == typeof i.className && -1 !== i.className.indexOf("waves-effect")) {
                e = i;
                break
            }
            i = i.parentElement
    ...
    function e(a, r, l, d) {
        ...
        var m = !1, b = {id: a.id || "P" + Math.abs(~~(Math.random() * new Date))}, w = l ? t.extend(!0, {}, l.defaults, d) : d || {}, x = t.extend({}, e.klasses(), w.klass), k = t(a), S = function () {
            ...
            constructor: S, $node: k, start: function () {
                return b && b.start ? C : (b.methods = {}, b.start = !0, b.open = !1, b.type = a.type, a.autofocus = a == s(), a.readOnly = !w.editable, a.id = a.id || b.id, "text" != a.type && (a.type = "text"), C.component = new l(C, w), C.$root = t(e._.node("div", h(), x.picker, 'id="' + a.id + '_root" tabindex="0"')), f(), w.formatSubmit && v(), p(), w.container ? t(w.container).append(C.$root) : k.after(C.$root), C.on({
                ...
                return t ? C.$root.html(h()) : C.$root.find("." + x.box).html(C.component.nodes(b.open)), C.trigger("render")
            }, stop: function () {
    ...
    i.prototype.set = function (t, e, i) {
        ...
        var o, r, s, l, u = this, c = i, d = n && n.interval ? n.interval : 1, h = -1 === u.item.enable, p = u.item.min, f = u.item.max, v = h && u.item.disable.filter(function (t) {
                if (e.isArray(t)) {
        ...
        var e = this, i = e.settings, r = e.item, s = r.now, l = r.select, u = r.highlight, c = r.view, d = r.disable, h = r.min, p = r.max, f = function (t, e) {
            ...
            return a.node("div", " ", i.klass["nav" + (t ? "Next" : "Prev")] + (t && c.year >= p.year && c.month >= p.month || !t && c.year <= h.year && c.month <= h.month ? " " + i.klass.navDisabled : ""), "data-nav=" + (t || -1) + " " + a.ariaAttr({
                role: "button",
                controls: e.$node[0].id + "_table"
            }) + ' title="' + (t ? i.labelMonthNext : i.labelMonthPrev) + '"')
        }, g = function (n) {
            var o = i.showMonthsShort ? i.monthsShort : i.monthsFull;
            return "short_months" == n && (o = i.monthsShort), i.selectMonths ? a.node("select", a.group({
                min: 0,
                max: 11,
                i: 1,
                node: "option",
            ...
            }), i.klass.selectMonth, (t ? "" : "disabled") + " " + a.ariaAttr({controls: e.$node[0].id + "_table"}) + ' title="' + i.labelMonthSelect + '"') : "short_months" == n ? a.node("div", o[c.month]) : a.node("div", o[c.month], i.klass.month)
        }, y = function (n) {
            var o = c.year, r = i.selectYears === !0 ? 5 : ~~(i.selectYears / 2);
            if (r) {
                var s = h.year, l = p.year, u = o - r, d = o + r;
                if (s > u && (d += s - u, u = s), d > l) {
                    var f = u - s, v = d - l;
                    u -= f > v ? v : f, d = l
                }
                return a.node("select", a.group({
                    min: u, max: d, i: 1, node: "option", item: function (t) {
                        return [t, 0, "value=" + t + (o == t ? " selected" : "")]
                    }
                }), i.klass.selectYear, (t ? "" : "disabled") + " " + a.ariaAttr({controls: e.$node[0].id + "_table"}) + ' title="' + i.labelYearSelect + '"')
            }
        ...
        return createDayLabel = function () {
            ...
            return e
        }, a.node("div", a.node("div", createWeekdayLabel(), "picker__weekday-display") + a.node("div", g("short_months"), i.klass.month_display) + a.node("div", createDayLabel(), i.klass.day_display) + a.node("div", y("raw"), i.klass.year_display), i.klass.date_display) + a.node("div", a.node("div", (i.selectYears ? y() + g() : g() + y()) + v() + v(1), i.klass.header) + a.node("table", f + a.node("tbody", a.group({
            min: 0,
            max: o - 1,
            i: 1,
            node: "tr",
            item: function (t) {
                ...
                return [a.group({
                    min: n * t - c.day + o + 1, max: function () {
                        ...
                        var n = l && l.pick == t.pick, o = u && u.pick == t.pick, r = d && e.disabled(t) || t.pick < h.pick || t.pick > p.pick, f = a.trigger(e.formats.toString, e, [i.format, t]);
