...
!function (e, t) {
    ...
    var t = function (e, t) {
        ...
        var e = document, o = function (n) {
            ...
            var r, s = this, l = ["bounds_changed", "center_changed", "click", "dblclick", "drag", "dragend", "dragstart", "idle", "maptypeid_changed", "projection_changed", "resize", "tilesloaded", "zoom_changed"], p = ["mousemove", "mouseout", "mouseover"], c = ["el", "lat", "lng", "mapType", "width", "height", "markerClusterer", "enableNewStyle"], g = n.el || n.div, h = n.markerClusterer, u = google.maps.MapTypeId[n.mapType.toUpperCase()], d = new google.maps.LatLng(n.lat, n.lng), m = n.zoomControl || !0, f = n.zoomControlOpt || {
                    style: "DEFAULT",
                    position: "TOP_LEFT"
                }, y = f.style || "DEFAULT", v = f.position || "TOP_LEFT", k = n.panControl || !0, w = n.mapTypeControl || !0, L = n.scaleControl || !0, b = n.streetViewControl || !0, _ = _ || !0, M = {}, x = {
                zoom: this.zoom,
                center: d,
                mapTypeId: u
            }, C = {
            ...
            var P = function (e, t) {
                ...
                if (i("gmaps_context_menu")) {
                    ...
                    p.innerHTML = o;
                    var r, c = p.getElementsByTagName("a"), g = c.length;
                    for (r = 0; g > r; r++) {
                        var h = c[r], u = function (o) {
                    ...
                    var d = a.apply(this, [s.el]), m = d[0] + t.pixel.x - 15, f = d[1] + t.pixel.y - 15;
    ...
    return l.prototype.getRoutes = function (e) {
        ...
        if (e.origin && e.destination)this.getRoutes({
            ...
            callback: function (o) {
                if (o.length > 0 && e.start && e.start(o[o.length - 1]), o.length > 0 && e.step) {
                    var n = o[o.length - 1];
                    if (n.legs.length > 0)for (var r, s = n.legs[0].steps, i = 0; r = s[i]; i++) {
                        r.step_number = i;
                        var a = {
                            path: r.path,
                            strokeColor: e.strokeColor,
        ...
        if (i)for (var d = 0; d < i.length; d++) {
            ...
            for (var f = 0; f < i[d].stylers.length; f++)for (var y in i[d].stylers[f]) {
        ...
        if (a) {
            ...
            var b = o.path;
            if (b.join)for (var _, f = 0; _ = b[f]; f++)a.push(_.join(",")); else a.push("enc:" + b);
